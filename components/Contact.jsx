...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append('access_key', 'a1342b15-cbec-41c7-a9ed-a8bef6404049');
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/contact-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none -z-10'>
      ...
      onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        <p className='flex justify-center min-h-8 mt-4'>{result}</p>
      </motion.form>
    </motion.div>
  )
};
